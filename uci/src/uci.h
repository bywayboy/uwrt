...
#define BUILD_CAST(_type) \
	static __inline struct uci_ ## _type *uci_to_ ## _type (struct uci_element *e) \
	{ \
 ...
 */
static __inline struct uci_package *
 ...
 */
static __inline struct uci_section *
 ...
 */
static __inline struct uci_option *
...
static __inline const char * uci_lookup_option_string(struct uci_context *ctx, struct uci_section *s, const char *name)
{
	struct uci_option *o;
